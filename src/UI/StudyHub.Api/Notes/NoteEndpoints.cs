...
public static class NoteEndpoints
{
    public static IEndpointRouteBuilder MapNoteEndpoints(this IEndpointRouteBuilder endpoints)
    {
        ...
        group.MapGet("/by-course/{courseId:guid}", (Guid courseId, INoteManagement noteManagement, CancellationToken cancellationToken)
            => noteManagement.GetByCourseIdAsync(courseId, cancellationToken));

        group.MapGet("/by-semester/{semesterId:guid}", (Guid semesterId, INoteManagement noteManagement, CancellationToken cancellationToken)
            => noteManagement.GetBySemesterIdAsync(semesterId, cancellationToken));
        ...
        group.MapGet("/{id:guid}/backlinks", (Guid id, INoteManagement noteManagement, CancellationToken cancellationToken)
            => noteManagement.GetBacklinksAsync(id, cancellationToken));
        ...
        group.MapPost("/{id:guid}/restore", (Guid id, INoteManagement noteManagement, CancellationToken cancellationToken)
            => noteManagement.RestoreAsync(id, cancellationToken));

        group.MapPost("/{id:guid}/documents/{documentId:guid}", (Guid id, Guid documentId, INoteManagement noteManagement, CancellationToken cancellationToken)
            => noteManagement.AttachDocumentAsync(id, documentId, cancellationToken));

        group.MapDelete("/{id:guid}/documents/{documentId:guid}", (Guid id, Guid documentId, INoteManagement noteManagement, CancellationToken cancellationToken)
            => noteManagement.DetachDocumentAsync(id, documentId, cancellationToken));
